            ...
            <table id="dataTable" class="table table-bordered table-striped"  name="areaTable">
                ...
                <tbody id="">
                	...
                	@foreach ($socialLinks as $socialLink)
                		<tr class="row_{{ $socialLink->id }}">
                			<td>{{ $sl++ }}</td>
                			<td>{{ $socialLink->name }}</td>
                            <td>{{ $socialLink->link }}</td>
                            <td>{{ $socialLink->order_by }}</td>
                			<td>
                                @php
                                    echo \App\Link::status($socialLink->id,$socialLink->status);
                                @endphp
                			</td>
                			<td>
                    			@php
                    				echo \App\Link::action($socialLink->id);
                    			@endphp                				
                			</td>
                		</tr>
                	@endforeach
