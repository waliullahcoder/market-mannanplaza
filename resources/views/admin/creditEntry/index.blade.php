                ...
                <tbody>
                    ...
                    <tr class="row_{{ $transactionList->id }}">
                        ...
                        @php
                            ...
                            $debit_head = \App\DebitEntry::where('voucher_no', $transactionList->voucher_no)->where('voucher_type', 'CV')->where('debit_amount', '>', 0)->first();
                            $debit_head = \App\CoaSetup::where('head_code', $debit_head->coa_head_code)->first();
                        @endphp
                        <td>{{ @$debit_head->head_name }}</td>
                        <td>
