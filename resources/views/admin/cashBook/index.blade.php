    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <div class="form-group">
                <select class="select2" id="cashBookHead" name="cashBookHead" data-placeholder="Select Account" required>
                    <option value="">Select Account Name</option>
                    @foreach ($cashBookLists as $cashBookList)
                        <option value="{{ $cashBookList->head_code }}"
                            {{ request('cashBookHead') == $cashBookList->head_code ? 'selected' : '' }}>
                            {{ $cashBookList->head_name }}
                        </option>
                    @endforeach
                </select>
            </div>
...
@section('print_card_header')
    ...
    <input type="hidden" name="cashBookHead" value="{{ request('cashBookHead') }}">
