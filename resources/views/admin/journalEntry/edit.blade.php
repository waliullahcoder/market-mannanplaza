        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <select name="unit" class="form-control select2" id="unit">
                    ...
                    <option value="{{ $unit->name }}"
                        @if ($journalEntry->unit_id == $unit->name)
                        selected
                        @endif
                        >{{ $unit->name }}</option>
                    @endforeach
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('remarks') ? ' has-danger' : '' }}">
                    ...
                    <input type="text" class="form-control remarks" id="remarks" name="remarks" value="{{ $journalEntry->narration }}">
                    ...
                    <table class="table table-bordered table-striped gridTable" >
                        ...
                        <tbody id="tbody">
                        	...
                        	@foreach ($journalEntries as $journalEntryInfo)
	                            ...
	                            <tr>
	                                <td>
	                                    <select class="chosen-select form-control coa coa_{{ $i }}" id="coa" name="coa[]">
