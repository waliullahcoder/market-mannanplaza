        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group {{ $errors->has('voucharNo') ? ' has-danger' : '' }}">
                    ...
                    <input type="text" class="form-control" id="voucharNo" name="voucharNo" value="{{ $voucherCode }}" placeholder="Enter Vouchar No" required readonly>
            ...
            <div class="col-md-2">
                <div class="form-group {{ $errors->has('name') ? ' has-danger' : '' }}">
                    ...
                    <input type="text" class="form-control add_datepicker" name="transactionDate" value="" placeholder="Select Transaction Date">
                </div>
            </div>
