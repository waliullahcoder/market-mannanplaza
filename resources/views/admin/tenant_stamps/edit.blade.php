    			    ...
    			    <form class="form-horizontal" action="{{ route($formLink) }}" id="formAddEdit" method="POST" enctype="multipart/form-data" name="form">
    				    ...
    				    <div class="card">
    				        <div class="custom-card-header">
    				            <div class="row">
    				                ...
    				                <div class="col-md-6 text-right">
    				                	<a class="btn btn-outline-info btn-lg" href="{{ route('positionInformation.index.stamp', $stamp->tenant->ID) }}">
                            ...
                            <div class="card-body">
                                ...
                                <input type="hidden" name="tenant_id" value="{{ $stamp->tenant->ID }}">
                                <input type="hidden" name="old_stamp_image" value="{{ $stamp->stamp_image }}">

                                <div class="row">
                                    <div class="col-md-8">
                                        <label for="Stamp No">Stamp No</label>
                                        <div class="form-group {{ $errors->has('stamp_no') ? ' has-danger' : '' }}">
                                            <input type="text" class="form-control" placeholder="Stamp No" name="stamp_no"
                                                value="{{ $stamp->stamp_no }}">
                                        </div>
                                    </div>

                                    <div class="col-md-4">
                                        <label for="Stamp No">Stamp Image</label>
                                        <div class="form-group {{ $errors->has('stamp_image') ? ' has-danger' : '' }}">
