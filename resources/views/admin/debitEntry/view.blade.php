            ...
            <table class="table table-borderless table-striped table-responsive-sm">
                <tbody>
                    ...
                    <tr>
                        ...
                        <th style="width: 10px; font-weight: bold;">:</th>
                        <td>{{ $debitEntry->coa->head_name }}</td>
                    </tr>
            ...
            <table class="table table-bordered table-striped table-responsive-sm">
                <thead class="thead-green">
                    <tr>
                        ...
                        <th class="text-right" style="font-weight: bold; width: 120px;">Debit</th>
                    </tr>
                </thead>
                <tbody id="tbody">
                    @php
                    ...
                    @foreach ($debitEntries as $debitEntryInfo)
                        ...
                        @endphp
                        <tr>
                            <td style="font-weight: bold;">{{ @$debitEntryInfo->coa->head_name }} -
                                {{ @$debitEntryInfo->coa->head_code }}</td>
