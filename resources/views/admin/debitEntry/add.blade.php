        ...
        <div class="row">
            {{-- <div class="col-md-4">
                ...
                <div class="form-group">
                    <select class="form-control select2" id="showroom" name="showroom">
            ...
            <div class="col-md-3">
                ...
                <select name="unit" class="form-control select2" id="unit">
                    ...
                    <option value="{{ $unit->name }}" @if (isset($sunit)) @if ($sunit==$unit->name)
                        seleced
                        @endif
                        @endif
                        >{{ $unit->name }}</option>
            ...
            <div class="col-md-3">
                <div class="form-group {{ $errors->has('voucharNo') ? ' has-danger' : '' }}">
                    ...
                    <input type="text" class="form-control" id="voucharNo" name="voucharNo" value="{{ $voucherCode }}" placeholder="Select Showroom For Generate Voucher No" readonly>
                ...
                <div class="form-group">
                    <table class="table table-bordered table-striped gridTable" >
                        ...
                        <tbody id="tbody">
                            <tr>
                                <td>
                                    <select class="chosen-select coa coa_1 form-control" id="coa" name="coa[]">
                                        <option value="">Select Account Name</option>
                                        @foreach ($coas as $coa)
