            ...
            <table id="dtb" class="table table-bordered table-striped" name="debitTable">
                <thead>
                    <tr>
                        ...
                        <th width="90px" class="text-center">Account Status</th>
                ...
                <tbody>
                    ...
                    <tr class="row_{{ $transactionList->id }}">
                        ...
                        @php
                            $debit_head_codes = \App\DebitEntry::where('voucher_no', $transactionList->voucher_no)->where('voucher_type', 'DV')->where('debit_amount', '>', 0)->pluck('coa_head_code')->toArray();
                            $debitHeads = \App\CoaSetup::whereIn('head_code', $debit_head_codes)->get();
                            $credit_head = \App\DebitEntry::where('voucher_no', $transactionList->voucher_no)->where('voucher_type', 'DV')->where('credit_amount', '>', 0)->first();
                            $credit_head = \App\CoaSetup::where('head_code', $credit_head->coa_head_code)->first();
                        @endphp
                        <td>
